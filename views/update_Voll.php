<?php
    ...
    if (isset($_POST['submit'])) {
        $initial = (int) $_SESSION['nb_place_initial'];
        $val = (int)$_POST['nb_place_initial'];
        if($val < $initial || $val <= 0){
            Session::set('error','LE NOMBRE DE VOL pa corect par ce qur < nombre de client a reserve'.$consome);
			Redirect::to('gestion_vol');
        }else{
            $exitVol = new VolsController();
            $exitVol->updateVol();
            Session::set('le vol modifier avec succes');
			Redirect::to('gestion_vol');
        }
            ...
            <div class="row mb-5 mt-5">
                ...
                <div class="col-md-10 order-md-1">
                    <form class="needs-validation" method='POST'>
                        <h2>Information de Voll Nº:<?php echo $vol->id_vol; ?> </h2><br> 
                        <div class="mb-3">
                            <div class="mb-3">
                            ...
                            <div>
                                <input type="text" name="nam" class="form-control" id="nam_voll" placeholder="Autre nom" value="<?php echo $vol->nam; ?>"  required>
                            </div>
                        </div><br>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="pays_depart" class="form-control" id="pays_depart" placeholder="Pays De Depart" value="<?php echo $vol->pays_depart; ?>"  required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="text">Pays De Arrive :</label>
                                <input type="text" name="pays_arrive" class="form-control" id="pays_arrive" placeholder="Pays De Arrive" value="<?php echo $vol->pays_arrive; ?>"  required>
                            </div>
                        </div><br>

                        <div class="mb-3">
                            <label for="text">Date De Voll :</label>
                            <input type="date" name="date_vol" class="form-control" id="date_vol" placeholder="Date De Voll" value="<?php echo $vol->date_vol; ?>"  required>
                        </div><br>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="text">Hour De Vol :</label>
                                <input type="number" name="hour_vol" class="form-control" id="hour_vol" placeholder="Hour De Vol" value="<?php echo $vol->hour_vol; ?>"  required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="text">Minute_vol :</label>
                                <input type="number" name="minute_vol" class="form-control" id="minute_vol" placeholder="Minute_vol" value="<?php echo $vol->minute_vol; ?>"  required>
                            </div>
                        </div><br>

                        <div class="mb-3">
                            <label for="text">Nombre De plasse De Voll :</label>
                            <?php $_SESSION['nombre_plass_rest'] = $vol->nb_place_rest; ?>
                            <input type="number" name="nb_place_initial" class="form-control" id="nb_place_initial" placeholder="Nombre De plasse De Voll" value="<?php echo $vol->nb_place_initial; ?>"  required>
                        </div><br>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="price" class="form-control" id="price" placeholder="Price Voll" value="<?php echo $vol->price; ?>"  required>
                        </div><br>	
                        <div class="mb-3">
                            <label for="text">Image :</label>
                            <input type="text" name="image" class="form-control" id="image" placeholder="Image" value="<?php echo $vol->image; ?>"  required >
                        </div><br>
                        <hr class="mb-4">
                        <input type="hidden" name="id_vol" value="<?php echo $vol->id_vol;?>">
                        <button class="btn btn-outline-success btn-lg btn-block" type="submit"  name="submit"><i class="fa fa-edit" ></i> Modifier</button>
                    </form>
                </div>
